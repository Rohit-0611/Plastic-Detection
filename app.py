...
def index():
      # Initialize processed_link variable
    ...
    if request.method == 'POST':
        ...
        processed_link = f"https://curaai.blob.core.windows.net/{PROCESSED_CONTAINER_NAME}/{processed_image_filename}"
...
def process_image(image_filename, model):
    ...
    results = model(pil_image)  # Assuming YOLO model takes a numpy array as input
